...
#  s.source   = { :git => 'https://github.com/AFNetworking/AFNetworking.git', :tag => s.version }
  ...
  s.osx.pod_target_xcconfig     = { 'PRODUCT_BUNDLE_IDENTIFIER' => 'com.idea.AFNetworking' }
...
#                                  }
  ...
  s.subspec 'UIKit' do |ss|
    ...
    ss.source_files = 'UIKit+AFNetworking/AFNetworkActivityIndicatorManager.{h,m}'
  end
